...
export const snapshots = {
  ...
  month3: {
    ...
    products: {
      ...
      marketEntry: { active: true, balance: 52000, yield: 10.53, fund: 'UTI Nifty 50 Index Fund', currentPE: 19.5, peZone: 'fair', deploymentPace: 1.0, stpProgress: 0.15 },
      accelerate: { active: false, balance: 0, yield: 14.2, funds: [], lastRebalance: null },
      navigate: { active: false, balance: 0, yield: 13.66, funds: [], lastRebalance: null },
    },
  ...
  month6: {
    ...
    products: {
      ...
      marketEntry: { active: true, balance: 160000, yield: 10.53, fund: 'UTI Nifty 50 Index Fund', currentPE: 19.5, peZone: 'fair', deploymentPace: 1.0, stpProgress: 0.45 },
      accelerate: { active: true, balance: 85000, yield: 14.2, funds: [
  ...
  month9: {
    ...
    products: {
      ...
      marketEntry: { active: true, balance: 480000, yield: 10.53, fund: 'UTI Nifty 50 Index Fund', currentPE: 18.2, peZone: 'fair', deploymentPace: 1.0, stpProgress: 0.75 },
      accelerate: { active: true, balance: 520000, yield: 14.2, funds: [
      ...
      navigate: { active: true, balance: 185000, yield: 13.66, funds: [
        { name: 'UTI Nifty 50 Index Fund', weight: 0.30, value: 55500 },
        { name: 'ICICI Nifty Next 50 Index Fund', weight: 0.20, value: 37000 },
        { name: 'HDFC Midcap Opportunities Fund', weight: 0.20, value: 37000 },
        { name: 'Parag Parikh Flexi Cap Fund', weight: 0.15, value: 27750 },
        { name: 'Motilal Oswal S&P 500 Index Fund', weight: 0.15, value: 27750 },
      ], lastRebalance: '2026-10-01' },
    },
    metrics: { totalNeevBalance: 1705000, extraEarned: 42000, extraEarnedToday: 305, monthsActive: 9, sweepCount: 9, totalSwept: 1610000 },
